...
class ProductsForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['image', 'name', 'price', 'description', 'availability_duration','category', 'quality', 'brand', 'color', 'contact_info', 'associated_classes']  # Include all the necessary fields
